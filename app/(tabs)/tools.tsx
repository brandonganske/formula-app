...
import { ShieldCheck, Clapperboard, Mail, MessageSquareWarning, Mic, TrendingUp } from 'lucide-react-native';
...
const TOOLS: Tool[] = [
  ...
  { key: 'breakdown', title: 'Video breakdown', sub: 'Why it works', Icon: TrendingUp, bg: D.ink, route: '/tools/breakdown', isNew: true },
